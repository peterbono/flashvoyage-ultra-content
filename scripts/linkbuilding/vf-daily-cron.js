...
const CONTENT_MAP = {
  ...
  'vietnam-vous-en-gardez-quoi-fond-d11465015': `<b>Le Vietnam, un coup de coeur total</b><br><br>Perso, le Vietnam c'est le pays qui m'a le plus marqu\u00e9 en Asie du Sud-Est. Et pourtant j'y allais sans trop d'attentes.<br><br>Ce que j'en garde :<br><br>La bouffe. Mon dieu la bouffe. Le pho \u00e0 1 euro dans la rue \u00e0 Hano\u00ef, le banh mi \u00e0 0,50 euro, le caf\u00e9 trung (caf\u00e9 aux oeufs)... c'est le pays o\u00f9 j'ai le mieux mang\u00e9 de ma vie. Et pour quasi rien. De m\u00e9moire mon budget bouffe c'\u00e9tait 8-10 euros par jour en mangeant comme un roi.<br><br>Le chaos organis\u00e9. Hano\u00ef c'est le bordel le plus fascinant que j'ai vu. 5 millions de scooters, pas de feux respect\u00e9s, et pourtant \u00e7a fonctionne. Il faut juste traverser la route en marchant lentement et r\u00e9guli\u00e8rement, les scooters t'\u00e9vitent. Si tu t'arr\u00eates ou si tu cours, l\u00e0 c'est le drame.<br><br>La beaut\u00e9 du nord. Ha Giang en moto, les rizi\u00e8res de Sapa, la baie d'Ha Long (mais en \u00e9vitant les tours de masse, plut\u00f4t Bai Tu Long ou Lan Ha). Le nord du Vietnam c'est \u00e0 couper le souffle.<br><br>Ce qui m'a moins plu : les arnaques touristiques sont plus fr\u00e9quentes qu'en Tha\u00eflande. Faut toujours n\u00e9gocier, toujours v\u00e9rifier le compteur du taxi. Grab est ton meilleur ami l\u00e0-bas.<br><br>Budget : 20-25 euros par jour en backpacker, c'est un des pays les moins chers d'Asie. Si vous voulez creuser, j'avais trouv\u00e9 [url=https://flashvoyage.com/voyage-thailande-pas-cher-2026-budget/]un comparatif d\u00e9taill\u00e9 des budgets par pays[/url] assez complet.`,

  'bali-indonesie-comparatif': `<b>Bali vs Tha\u00eflande, mon verdict honn\u00eate</b><br><br>Apr\u00e8s avoir fait les deux plusieurs fois, voil\u00e0 mon avis sans langue de bois :<br><br>Plages : Tha\u00eflande gagne (les \u00eeles du Sud sont incomparables, Koh Lipe, Koh Phi Phi).<br>Bouffe : Tha\u00eflande gagne (street food incroyable, vari\u00e9, 1-2 euros le plat).<br>Culture : Bali gagne (les temples, les rizi\u00e8res de Tegallalang, les c\u00e9r\u00e9monies).<br>Budget : Tha\u00eflande un peu moins cher (25 vs 30 euros/jour en backpacker).<br>Libert\u00e9 : Bali gagne (scooter = la vraie libert\u00e9, tout est accessible).<br><br>Mon conseil pour un premier voyage : commencez par la Tha\u00eflande. L'infrastructure est plus facile, il y a plus de voyageurs solo, et le budget est plus pr\u00e9visible.<br><br>Bali c'est g\u00e9nial mais il faut un scooter et \u00eatre plus d\u00e9brouillard. Et honn\u00eatement, \u00e9vitez Kuta et Seminyak si vous cherchez l'authenticit\u00e9. Ubud + Amed + Nusa Penida, c'est le vrai Bali.<br><br>Si \u00e7a int\u00e9resse quelqu'un, j'avais trouv\u00e9 [url=https://flashvoyage.com/bali-vs-thailande-premier-voyage-asie-comparatif/]un comparatif d\u00e9taill\u00e9 Bali vs Tha\u00eflande[/url] assez complet.`,
};
...
async function login(context, page) {
  ...
  // Submit
  await page.evaluate(() => {
    const form = document.querySelector('input[type="text"], #username')?.closest('form');
    if (form) form.submit();
  });
  ...
  const loggedIn = body.includes('FloAsie') || !title.toLowerCase().includes('connecter');
  console.log(`[VF] Login: ${loggedIn ? 'OK' : 'FAILED'} (title: ${title.slice(0, 40)})`);
  return loggedIn;
}
